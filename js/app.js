// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["bfzy","bwzy","cjhw","ckzy","dbzy","ffzy","heimuer","hwba","jisu","jkun","lsb","mdzy","mozhua","r155","ruyi","siwa","souav","tyyszy","wolong","zy360"]'); // 默认选中黑木耳
